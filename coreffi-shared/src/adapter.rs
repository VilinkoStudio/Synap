...
pub use crate::types::{
    ...
    SearchMatchRangeDTO, SearchResultDTO, SearchSourceDTO, SearchTextMatchDTO, ShareStatsDTO,
    SyncSessionDTO,
    SyncSessionRecordDTO,
    SyncSessionRoleDTO, SyncStatsDTO, SyncStatusDTO, SyncTransportKindDTO, TimelineDensityPointDTO,
